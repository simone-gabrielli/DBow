...
namespace DBow {
	...
	public:
		 ...
		 */
		void Create(const std::vector<std::vector<float> >& training_features);
	...
	protected:
		 ...
		 * @return word id
		 */
		WordId Transform(const std::vector<float>::const_iterator &pfeature) const;
	...
	protected:
		...
		typedef std::vector<float>::const_iterator pFeature;
	...
	protected:
		 ...
		 *    floats
		 */
		void HKMeansStep(NodeId parentId, const std::vector<pFeature> &pfeatures, 
			int level, std::vector<float>& clusters);
		 ...
		 */
		void RandomClustersPlusPlus(std::vector<float>& clusters, 
									const std::vector<pFeature> &pfeatures) const;
		 ...
		 */
		void SetNodeWeights(const std::vector<std::vector<float> >& training_features);
